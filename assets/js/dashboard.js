(function($) {
  ...
  $(function() {
    ...
    if ($("#traffic-chart").length) {
      ...
      var gradientStrokePurp = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokePurp.addColorStop(0, '#8e2de2');
      gradientStrokePurp.addColorStop(1, '#4a00e0');
      var gradientLegendPurp = 'linear-gradient(to right, #8e2de2, #4a00e0)';

      var gradientStrokeYellow = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeYellow.addColorStop(0, '#c6ffdd');
      gradientStrokeYellow.addColorStop(1, '#fbd786');    
      var gradientLegendYellow = 'linear-gradient(to right, #c6ffdd, #fbd786)';

      var gradientStrokeDark = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeDark.addColorStop(0, '#0f0c29');
      gradientStrokeDark.addColorStop(1, '#24243e');
      var gradientLegendDark = 'linear-gradient(to right, #0f0c29, #24243e)';

      var gradientStrokeSuper = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeSuper.addColorStop(0, '#0099f7');
      gradientStrokeSuper.addColorStop(1, '#f11712');
      var gradientLegendSuper = 'linear-gradient(to right, #0099f7, #f11712';

      var gradientStrokeGold = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeGold.addColorStop(0, '#FFD194');
      gradientStrokeGold.addColorStop(1, '#D1913C');
      var gradientLegendGold = 'linear-gradient(to right, #FFD194, #D1913C)';

      var trafficChartData = {
        datasets: [{
          data: [1, 2, 1, 9, 29, 2, 5, 51],
          backgroundColor: [
            gradientStrokeBlue,
            gradientStrokeGreen,
            gradientStrokeRed,
